...
print("Loading FULL AlexNet on Edge CPU...")
...
print("\n" + "="*50)
print("STARTING PI 500-RUN BASELINE (ALEXNET)")
print("="*50)
...
for i in range(1, 501):
    ...
    if i % 50 == 0:
        print(f"Run {i}/500 completed... (Latency: {math_time*1000:.1f}ms)")

print("\n" + "="*50)
print("PI EDGE CONTROL RESULTS (ALEXNET)")
print("="*50)
