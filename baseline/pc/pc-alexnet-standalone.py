...
print("Loading FULL AlexNet on RTX 4070 Ti...")
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
full_model = models.alexnet(weights='DEFAULT').eval().to(device)
...
print("\n" + "="*50)
print("STARTING PC 500-RUN BASELINE (ALEXNET)")
print("="*50)
...
for i in range(1, 501):
    # Read GPU power BEFORE math (in Watts)
    ...
    # Read GPU power AFTER math (in Watts)
...
print("\n" + "="*50)
print("PC CLOUD CONTROL RESULTS (ALEXNET)")
print("="*50)
